...
int main (int argc, char *argv[])
{
	...
	//errChk (aboutPanel = LoadPanel (0, "AcquisitionSimulation.uir", ABOUTPANEL));
...
void CVICALLBACK OnMenuBar (int menuBar, int menuItem, void *callbackData, int panel)
{
	switch( menuItem )
	{
		...
		case MENUBAR_SIGNAL_SINE:
			...
			//To do: 02
			//*********
			QueueUserEvent(SIGNALTYPE_SINEWAVE, panel, MAIN_PANEL);
		...
		case MENUBAR_SIGNAL_TRIANGLE:
			...
			//To do: 02
			//*********
			QueueUserEvent(SIGNALTYPE_TRIANGLEWAVE, panel, MAIN_PANEL);
		...
		case MENUBAR_SIGNAL_SQUARE:
			...
			//To do: 02
			//*********
			QueueUserEvent(SIGNALTYPE_SQUAREWAVE, panel, MAIN_PANEL);
		...
		case MENUBAR_SIGNAL_NOISE:
			...
			//To do: 02
			//*********
			QueueUserEvent(SIGNALTYPE_NOISE, panel, MAIN_PANEL);
